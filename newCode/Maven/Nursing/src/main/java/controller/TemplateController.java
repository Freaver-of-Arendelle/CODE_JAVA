...
import model.service.impl.TemplateService;
...
public class TemplateController {
    ...
    void test() {
        ...
        controller.clear();
        controller.addTemplate(0, "谁知道呢", new HashSet<>(problems.subList(0, 3)), "A");
        controller.addTemplate(1, "差不多得了", new HashSet<>(problems.subList(3, 6)), "B");
        controller.addTemplate(2, "你在影射什么", new HashSet<>(problems.subList(6, 9)), "C");
