...
//            }
            ...
            jb.addActionListener(e -> {
                ...
                for (Vector vector : dataVector) {
                    if (vector.get(0).equals(true)) {
                        estimators.add(new Estimator(((String) vector.get(1)), ((String) vector.get(3)), null, null, new Date(), username
                                , null));
                    }
                }
...
//    private static String emergencyTel;
    ...
    private void original(JTextField nameField3, JTextField birFiled3, JTextField genderField3,
                          JTextField idField3, JTextField telField3, JTextField emeFiled3,
                          JTextField emeTelField3, JFrame frame3, Vector vector) {
