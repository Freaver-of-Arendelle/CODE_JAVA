...
import model.service.impl.ProblemService;
...
public class ProblemController {
    ...
    public static void main(String[] args) {
        ...
        Problem problem1 = new Problem(0, question1, answer1, "A");
        Problem problem2 = new Problem(1, question2, answer2, "B");
        Problem problem3 = new Problem(2, question3, answer3, "C");
        Problem problem4 = new Problem(3, question4, answer4, "A");
        Problem problem5 = new Problem(4, question5, answer5, "B");
        Problem problem6 = new Problem(5, question6, answer6, "C");
        Problem problem7 = new Problem(6, question7, answer7, "A");
        Problem problem8 = new Problem(7, question8, answer8, "B");
        Problem problem9 = new Problem(8, question9, answer9, "C");
     ...
     * @return 是否增加成功
     */
    public boolean addProblem(int id, String question, String[] answers, String type) {
        setPath();
        return service.getCreate().add(new Problem(id, question, answers, type));
    }
