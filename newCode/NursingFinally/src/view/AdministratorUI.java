...
public class AdministratorUI extends JFrame {
    ...
    private void saveBtnActionPerformed(ActionEvent e) {
        ...
        for (Vector vector1 : dataVector) {
            controller.addStaff(new Staff(((String)vector1.get(1)), ((String)vector1.get(2)), ((Date)vector1.get(3)),
                ((String)vector1.get(4)), ((String)vector1.get(5)), ((String)vector1.get(6))));
        }
        this.dispose();
    }
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("resources.administrator");
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //======== scrollPane1 ========
                {
                    ...
                    table1.setModel(new DefaultTableModel(new Object[][] {},
                        new String[] {" ", "\u7528\u6237\u540d", "\u59d3\u540d", "\u51fa\u751f\u65e5\u671f",
                            "\u4e13\u957f", "\u804c\u79f0", "\u8054\u7cfb\u7535\u8bdd"}) {
                        Class<?>[] columnTypes =
                            new Class<?>[] {Boolean.class, String.class, String.class, Date.class, String.class,
                ...
                contentPanelLayout.setHorizontalGroup(contentPanelLayout.createParallelGroup().addGroup(
                    contentPanelLayout.createSequentialGroup().addGap(40, 40, 40)
                        .addComponent(nameField, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(searchBtn)
                    ...
                    contentPanelLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
                        ...
                        .addGap(646, 646, 646)).addGroup(contentPanelLayout.createSequentialGroup().addGap(15, 15, 15)
                    .addGroup(contentPanelLayout.createParallelGroup().addGroup(
                        contentPanelLayout.createSequentialGroup()
                            ...
                            .addContainerGap()).addGroup(contentPanelLayout.createSequentialGroup()
                ...
                contentPanelLayout.setVerticalGroup(contentPanelLayout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup().addGroup(
                        contentPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(searchBtn)
                        ...
                        .addComponent(selCB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                            GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addGroup(
                            contentPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                .addComponent(deleteBtn).addComponent(addBtn)).addGap(18, 18, 18)
            ...
            //======== buttonBar ========
            {
                ...
                buttonBarLayout.setHorizontalGroup(buttonBarLayout.createParallelGroup().addGroup(
                    buttonBarLayout.createSequentialGroup().addGap(60, 60, 60)
                ...
                buttonBarLayout.setVerticalGroup(buttonBarLayout.createParallelGroup().addGroup(
                    buttonBarLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(saveBtn)
        ...
        //======== frame2 ========
        {
            ...
            //======== dialogPane2 ========
            {
                ...
                //======== contentPanel2 ========
                {
                    ...
                    contentPanel2Layout.setHorizontalGroup(contentPanel2Layout.createParallelGroup().addGroup(
                        contentPanel2Layout.createSequentialGroup().addGap(95, 95, 95).addGroup(
                            contentPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(label2, GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)).addGap(18, 18, 18)
                            .addGroup(contentPanel2Layout.createParallelGroup()
                                ...
                                .addComponent(passwordField)).addGap(18, 18, 18).addGroup(
                            contentPanel2Layout.createParallelGroup()
                                .addComponent(userLabel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                    Short.MAX_VALUE).addGroup(contentPanel2Layout.createSequentialGroup()
                                .addComponent(pwLabel, GroupLayout.PREFERRED_SIZE, 143, GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))).addContainerGap())
                        .addGroup(GroupLayout.Alignment.TRAILING,
                            contentPanel2Layout.createSequentialGroup().addContainerGap(202, Short.MAX_VALUE).addGroup(
                                contentPanel2Layout.createParallelGroup().addGroup(GroupLayout.Alignment.TRAILING,
                                    contentPanel2Layout.createSequentialGroup()
                                        .addComponent(label1, GroupLayout.PREFERRED_SIZE, 157,
                                            GroupLayout.PREFERRED_SIZE).addGap(190, 190, 190))
                                    .addGroup(GroupLayout.Alignment.TRAILING,
                                        contentPanel2Layout.createSequentialGroup().addComponent(label3)
                                            .addGap(205, 205, 205)))));
                    contentPanel2Layout.setVerticalGroup(contentPanel2Layout.createParallelGroup().addGroup(
                        contentPanel2Layout.createSequentialGroup()
                            ...
                            .addGap(61, 61, 61).addComponent(label3)
                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(
                            contentPanel2Layout.createParallelGroup().addGroup(
                                contentPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                ...
                //======== buttonBar2 ========
                {
                    ...
                    buttonBar2Layout.setHorizontalGroup(buttonBar2Layout.createParallelGroup().addGroup(
                        buttonBar2Layout.createSequentialGroup().addGap(51, 51, 51)
                    ...
                    buttonBar2Layout.setVerticalGroup(buttonBar2Layout.createParallelGroup().addGroup(
                        buttonBar2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(cancelButton)
