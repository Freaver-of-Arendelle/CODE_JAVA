...
public class PatientUI extends JFrame {
    ...
    private class JTableEmbedButton extends AbstractCellEditor implements TableCellEditor, TableCellRenderer {
        ...
        public JTableEmbedButton(String title) {
            ...
            jb.addActionListener(e -> {
                Set<Estimator> estimators = EstimatorController.getSingleton().getEstimators();
                if (estimators == null) {
                    estimators = new HashSet<>();
                }
                for (Vector vector : dataVector) {
                    if (vector.get(0).equals(true)) {
                        estimators.add(
                            new Estimator(((String)vector.get(1)), ((String)vector.get(3)), null, null, new Date(),
                                username, null));
                    }
                }
                EstimatorUI ui = new EstimatorUI(new Vector<>(estimators));
                ui.setVisible(true);
            });
    ...
    private void addBtnActionPerformed(ActionEvent e) {
        ...
        original(nameField3, birFiled3, genderField3, idField3, telField3, emeFiled3, emeTelField3, frame3, null);
    }

    private void original(JTextField nameField3, JTextField birFiled3, JTextField genderField3, JTextField idField3,
        JTextField telField3, JTextField emeFiled3, JTextField emeTelField3, JFrame frame3, Vector vector) {
        ...
        if (vector == null) {
            ...
            nameField3.setText(((String)vector.get(1)));
            birFiled3.setText(vector.get(2).toString());
            genderField3.setText((String)vector.get(3));
            idField3.setText((String)vector.get(4));
            telField3.setText((String)vector.get(5));
            emeFiled3.setText((String)vector.get(6));
            emeTelField3.setText((String)vector.get(7));
        }
    ...
    private void modifyBtnActionPerformed(ActionEvent e) {
        ...
        original(nameField2, birFiled2, genderField2, idField2, telField2, emeFiled2, emeTelField2, frame2, vector);
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("resources.patient");
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //======== scrollPane1 ========
                {
                    ...
                    table1.setModel(new DefaultTableModel(new Object[][] {},
                        new String[] {" ", "\u59d3\u540d", "\u51fa\u751f\u65e5\u671f", "\u6027\u522b",
                            "\u8eab\u4efd\u8bc1\u53f7", "\u8054\u7cfb\u7535\u8bdd", "\u7d27\u6025\u8054\u7cfb\u4eba",
                            "\u7d27\u6025\u8054\u7cfb\u4eba\u7535\u8bdd", null}) {
                        Class<?>[] columnTypes =
                            new Class<?>[] {Boolean.class, String.class, Date.class, String.class, String.class,
                ...
                contentPanelLayout.setHorizontalGroup(
                    contentPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(
                        contentPanelLayout.createSequentialGroup().addGroup(contentPanelLayout.createParallelGroup()
                            .addComponent(nameField, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)
                            .addGroup(
                                contentPanelLayout.createSequentialGroup().addContainerGap().addComponent(delBtn)))
                            .addGroup(contentPanelLayout.createParallelGroup().addGroup(
                                ...
                                contentPanelLayout.createSequentialGroup()
                                    ...
                                    .addComponent(temBtn).addGap(18, 18, 18))).addGroup(
                            contentPanelLayout.createParallelGroup().addGroup(
                                contentPanelLayout.createSequentialGroup().addGap(6, 6, 6).addComponent(addBtn))
                                .addComponent(modifyBtn)).addContainerGap()).addGroup(GroupLayout.Alignment.LEADING,
                        contentPanelLayout.createSequentialGroup().addContainerGap()
                ...
                contentPanelLayout.setVerticalGroup(contentPanelLayout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup().addGroup(
                        contentPanelLayout.createParallelGroup().addGroup(
                            contentPanelLayout.createSequentialGroup().addGap(21, 21, 21).addGroup(
                                contentPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    .addComponent(searchBtn)
                                    .addComponent(nameField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 18, Short.MAX_VALUE))
                            .addGroup(GroupLayout.Alignment.TRAILING,
                                contentPanelLayout.createSequentialGroup().addContainerGap(39, Short.MAX_VALUE)
                                    .addComponent(modifyBtn))).addGap(8, 8, 8).addGroup(
                        contentPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(addBtn)
                            .addComponent(temBtn).addComponent(delBtn)).addGap(12, 12, 12)
            ...
            //======== buttonBar ========
            {
                ...
                buttonBarLayout.setHorizontalGroup(buttonBarLayout.createParallelGroup().addGroup(
                    buttonBarLayout.createSequentialGroup().addGap(122, 122, 122)
                        ...
                        .addGap(125, 125, 125)));
                buttonBarLayout.setVerticalGroup(buttonBarLayout.createParallelGroup().addGroup(
                    buttonBarLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(returnBtn)
        ...
        //======== frame2 ========
        {
            ...
            //======== dialogPane2 ========
            {
                    ...
                    contentPanel2Layout.setHorizontalGroup(
                        contentPanel2Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            .addGroup(GroupLayout.Alignment.LEADING,
                                contentPanel2Layout.createSequentialGroup().addContainerGap().addGroup(
                                    contentPanel2Layout.createParallelGroup()
                                        .addComponent(label7, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(GroupLayout.Alignment.TRAILING,
                                            contentPanel2Layout.createSequentialGroup().addGap(0, 7, Short.MAX_VALUE)
                                    ...
                                    contentPanel2Layout.createParallelGroup()
                                        ...
                                        .addComponent(nameField2, GroupLayout.Alignment.TRAILING,
                                    ...
                                    .addGap(169, 169, 169)));
                    contentPanel2Layout.setVerticalGroup(contentPanel2Layout.createParallelGroup().addGroup(
                        contentPanel2Layout.createSequentialGroup().addGap(12, 12, 12).addGroup(
                            contentPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGap(0, 1, Short.MAX_VALUE).addGroup(contentPanel2Layout.createParallelGroup().addGroup(
                            contentPanel2Layout.createSequentialGroup().addGap(7, 7, 7)
                                .addComponent(birFiled2, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
                            .addComponent(label2, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 25,
                            ...
                            .addGap(7, 7, 7).addGroup(
                            contentPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                ...
                //======== buttonBar2 ========
                {
                    ...
                    buttonBar2Layout.setHorizontalGroup(buttonBar2Layout.createParallelGroup().addGroup(
                        buttonBar2Layout.createSequentialGroup().addContainerGap(75, Short.MAX_VALUE)
                            ...
                            .addGap(96, 96, 96)));
                    buttonBar2Layout.setVerticalGroup(buttonBar2Layout.createParallelGroup().addGroup(
                        buttonBar2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(saveBtn2)
        ...
        //======== frame3 ========
        {
            ...
            //======== dialogPane3 ========
            {
                ...
                //======== contentPanel3 ========
                {
                    ...
                    contentPanel3Layout.setHorizontalGroup(
                        contentPanel3Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            .addGroup(GroupLayout.Alignment.LEADING,
                                contentPanel3Layout.createSequentialGroup().addContainerGap().addGroup(
                                    contentPanel3Layout.createParallelGroup()
                                        .addComponent(label14, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(label9, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                            126, Short.MAX_VALUE)
                                        .addComponent(label8, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                            126, Short.MAX_VALUE)
                                        .addComponent(label10, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                            126, Short.MAX_VALUE)
                                        .addComponent(label11, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                            126, Short.MAX_VALUE)
                                    ...
                                    contentPanel3Layout.createParallelGroup()
                                        ...
                                        .addComponent(nameField3, GroupLayout.Alignment.TRAILING,
                                            GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
                                    ...
                                    .addGap(169, 169, 169)));
                    contentPanel3Layout.setVerticalGroup(contentPanel3Layout.createParallelGroup().addGroup(
                        contentPanel3Layout.createSequentialGroup().addGap(12, 12, 12).addGroup(
                            contentPanel3Layout.createParallelGroup()
                                .addComponent(nameField3, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
                                .addComponent(label8, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                    Short.MAX_VALUE)).addGap(7, 8, Short.MAX_VALUE).addGroup(
                            contentPanel3Layout.createParallelGroup()
                                .addComponent(birFiled3, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 25,
                                    GroupLayout.PREFERRED_SIZE)
                                .addComponent(label9, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 25,
                                    GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(
                            contentPanel3Layout.createParallelGroup()
                            ...
                            .addGap(7, 7, 7).addGroup(
                            contentPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                ...
                //======== buttonBar3 ========
                {
                    ...
                    buttonBar3Layout.setHorizontalGroup(buttonBar3Layout.createParallelGroup().addGroup(
                        buttonBar3Layout.createSequentialGroup().addContainerGap(75, Short.MAX_VALUE)
                            ...
                            .addGap(96, 96, 96)));
                    buttonBar3Layout.setVerticalGroup(buttonBar3Layout.createParallelGroup().addGroup(
                        buttonBar3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(saveBtn3)
