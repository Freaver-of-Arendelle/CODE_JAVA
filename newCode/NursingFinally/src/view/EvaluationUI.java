...
public class EvaluationUI extends JFrame {
    ...
    private void okButtonActionPerformed(ActionEvent e) {
        ...
        for (Vector tempVector : dataVector) {
            estimators.add(
                new Estimator(((String)tempVector.get(0)), ((String)tempVector.get(1)), ((String)tempVector.get(2)),
                    ((String)tempVector.get(3)), ((Date)tempVector.get(4)), ((String)tempVector.get(5)),
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("resources.evaluation");
        ...
        //======== dialogPane ========
        {
            ...
            //======== buttonBar ========
            {
                ...
                buttonBarLayout.setHorizontalGroup(buttonBarLayout.createParallelGroup().addGroup(
                    buttonBarLayout.createSequentialGroup().addGap(38, 38, 38)
                ...
                buttonBarLayout.setVerticalGroup(buttonBarLayout.createParallelGroup().addGroup(
                    buttonBarLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(okButton)
