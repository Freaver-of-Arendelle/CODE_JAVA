...
public class EstimatorUI extends JFrame {
    ...
    private void cancelBtnActionPerformed(ActionEvent e) {
        ...
        for (Vector vector1 : dataVector) {
            singleton.addEstimator(
                new Estimator(((String)vector1.get(0)), ((String)vector1.get(1)), ((String)vector1.get(2)),
                    ((String)vector1.get(3)), ((Date)vector1.get(4)), ((String)vector1.get(5)),
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("resources.estimator");
        ...
        //======== dialogPane ========
        {
                ...
                contentPanelLayout.setVerticalGroup(contentPanelLayout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup().addGroup(
                        contentPanelLayout.createParallelGroup().addGroup(
                            contentPanelLayout.createSequentialGroup().addGap(36, 36, 36)
                                .addComponent(selCB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.PREFERRED_SIZE)).addGroup(
                            contentPanelLayout.createSequentialGroup().addGap(23, 23, 23).addComponent(startBtn)))
                        .addGap(18, 18, 18).addComponent(scrollPane1, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)));
            }
            ...
            //======== buttonBar ========
            {
                ...
                buttonBarLayout.setHorizontalGroup(buttonBarLayout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING,
                        buttonBarLayout.createSequentialGroup().addContainerGap(455, Short.MAX_VALUE)
                            .addComponent(cancelBtn, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
                            .addGap(124, 124, 124)));
                buttonBarLayout.setVerticalGroup(buttonBarLayout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING,
                        buttonBarLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(cancelBtn)));
            }
