...
import dao.DiskIO;
import model.impl.CoffeeAccessory;
...
public class DiskIOImpl implements DiskIO {
    ...
    public void show() {
        ...
        for (var c : stringList) {
            ...
            Product product = new CoffeeAccessory(strings[0].strip(), strings[1], Float.parseFloat(strings[2]), Integer.parseInt(strings[3].strip()));
